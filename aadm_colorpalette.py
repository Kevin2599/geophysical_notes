...
# map0=ax[0].pcolor(np.random.rand(10,10),cmap='gist_rainbow')
# ax[0].set_title('gist_rainbow')
# map1=ax[1].pcolor(np.random.rand(10,10),cmap='jetsaw_r')
# ax[1].set_title('jet/sawtooth reverse')
# map2=ax[2].pcolor(np.random.rand(10,10),cmap='jetsaw')
# ax[2].set_title('jet/sawtooth')
# plt.colorbar(map0, ax=ax[0])
# plt.colorbar(map1, ax=ax[1])
# plt.colorbar(map2, ax=ax[2])
...
cm.register_cmap(name='magma', cmap=cmaps['magma'])
cm.register_cmap(name='inferno', cmap=cmaps['inferno'])
cm.register_cmap(name='plasma', cmap=cmaps['plasma'])
...
del _magma_data, _inferno_data, _plasma_data, _viridis_data, cmaps, data, name
del cm, LinearSegmentedColormap, ListedColormap, creacolormap, make_cmap, reverse_colourmap
